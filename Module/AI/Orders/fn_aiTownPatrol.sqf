...
["INFORMATION", Format ["aiTownPatrol.sqf.sqf: [%1] Team [%2] is patrolling at [%3].", side _team,_team,_destination]] Call WFCO_FNC_LogContent;

[_team, true, _wps] Call WFSE_fnc_aiWpAdd;