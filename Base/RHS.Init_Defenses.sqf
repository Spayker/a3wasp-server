...
missionNamespace setVariable ['WF_NEURODEF_EAST_BASE',[
    ...
    ["HeliH",[-8.06445,15.25,0],0],
    ["RU_WarfareBBarracks",[8.91406,-14.2578,-0.600006],0],
    ["BTR90_HQ_unfolded",[-11.7051,-14.7051,0],90],
    ["US_WarfareBBarrier10xTall_EP1",[20.6318,6.98145,0],90],
    ["US_WarfareBBarrier10xTall_EP1",[-23.4258,-7.65527,0],90],
    ["US_WarfareBBarrier10xTall_EP1",[-0.323242,-30.1289,0],0],
    ["US_WarfareBBarrier10xTall_EP1",[-0.0878906,29.1484,0],0],
    ["Land_HBarrierTower_F",[17.2803,24.665,0],180],
    ["Land_HBarrierTower_F",[16.2432,-25.417,0],90],
    ["US_WarfareBBarrier10xTall_EP1",[20.6768,-22.3057,0],90],
    ["US_WarfareBBarrier10xTall_EP1",[20.6768,22.2783,0],90],
    ["Land_HBarrierTower_F",[-19.0898,-24.624,0],0],
    ["Land_HBarrierTower_F",[-17.3887,26.0361,0],270],
    ["US_WarfareBBarrier10xTall_EP1",[-23.4258,22.4785,0],90],
    ["US_WarfareBBarrier10xTall_EP1",[-23.4258,-22.6533,0],90],
    ["US_WarfareBBarrier10xTall_EP1",[14.6885,-30.0479,0],0],
    ["US_WarfareBBarrier10xTall_EP1",[14.6885,29.0986,0],0],
    ["US_WarfareBBarrier10xTall_EP1",[-15.6221,-30.1768,0],0],
    ["US_WarfareBBarrier10xTall_EP1",[-15.415,29.1445,0],0],
